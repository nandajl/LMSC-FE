...
export default function Grup() {
  return (
    <>
      ...
      <div className='pr-8'>
        <Link to='grup'>
          <p className='font-bold text-xl mb-5 hover:text-secondary'>Grup</p>
        </Link>
        <Link to='materi'>
          <p className='font-bold text-xl mb-5 hover:text-secondary'>Materi</p>
        </Link>
        <Link to='test'>
          <p className='font-bold text-xl mb-5 hover:text-secondary'>Test</p>
        </Link>
        <Link to='feedback'>
